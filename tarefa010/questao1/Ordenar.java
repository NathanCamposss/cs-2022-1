...
public class Ordenar {
    ...
    public static void main(String[] args) {
        ...
        QuickSort.qSortRecursivo(lista100, 0, lista100.length-1);
        long elapsed = System.currentTimeMillis() - start;
        System.out.println("Tempo do quickSort recursivo com 100 valores: "+elapsed);

        long comeco = System.currentTimeMillis();
        QuickSort.quickSortIterativo(lista1001, 0, lista100.length-1);
        long fim = System.currentTimeMillis() - comeco;
        System.out.println("Tempo do quickSort iterativo com 100 valores: "+fim);

        long start1 = System.currentTimeMillis();
        QuickSort.qSortRecursivo(lista1000, 0, lista1000.length-1);
        long elapsed1 = System.currentTimeMillis() - start1;
        System.out.println("Tempo do quickSort recursivo com 1000 valores: "+elapsed1);
        ...
        System.out.println("Tempo do quickSort iterativo com 1000 valores: "+fim1);
        
        long start2 = System.currentTimeMillis();
        QuickSort.qSortRecursivo(lista10000, 0, lista10000.length-1);
        long elapsed2 = System.currentTimeMillis() - start2;
        System.out.println("Tempo do quickSort recursivo com 10000 valores: "+elapsed2);
        ...
        System.out.println("Tempo do quickSort iterativo com 10000 valores: "+fim2);
